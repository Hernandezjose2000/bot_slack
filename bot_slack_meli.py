...
def enviar_mensajes_feriados(lista_feriados:list, fecha_actual:str) ->None:
    ...
    if len(lista_feriados) != 0:
        for id_feriado in range(len(lista_feriados)): 
            ...
            while contador_intentos < 2:
                ...
                try:
                    client.chat_postMessage(channel='#team', 
                    text= f"FERIADO: {lista_feriados[id_feriado][0]} / {lista_feriados[id_feriado][1]} / {lista_feriados[id_feriado][2]}")
                    ...
                    if contador_intentos == 2:
                        feriados_no_enviados.append((lista_feriados[id_feriado][0], 
                                                    lista_feriados[id_feriado][1],lista_feriados[id_feriado][2]))
    ...
    if mensaje_enviado == False:
        ...
        while contador_intentos < 2:
            ...
            try:
                client.chat_postMessage(channel='#team', text= "HOY NO HAY FERIADO EN NINGUN SITE.")
                contador_intentos = 2
